...
```typescript
// Check brands/{brand}.yml → visual.reference_styles
// Match content topic against mood_keywords
```

**Key styles (givecare):**
- `instax_wide` - Polaroid flash aesthetic
- `modern_flat_illustration` - Electric Cream palette vectors
- `organic_cellular` - Abstract texture patterns
- `bold_portrait` - Editorial photography
- `editorial_typography` - Typography-as-visual
