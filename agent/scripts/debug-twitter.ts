...
async function main() {
  // Test SCTY (default) - change to GIVECARE to test other brand
  const creds: Creds = {
    apiKey: process.env.TWITTER_SCTY_API_KEY!,
    apiSecret: process.env.TWITTER_SCTY_API_SECRET!,
    accessToken: process.env.TWITTER_SCTY_ACCESS_TOKEN!,
    accessSecret: process.env.TWITTER_SCTY_ACCESS_SECRET!
  }
