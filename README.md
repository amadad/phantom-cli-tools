...
- `agent/src/domain/` — typed workflow, run, and artifact model
- `agent/src/brands/` — brand foundation loader
- `agent/src/runtime/` — SQLite-backed runtime and workflow engine
- `agent/src/commands/` — public CLI commands
- `brands/<brand>/brand.yml` — brand foundations
- `state/` — runtime database, artifacts, and exports
